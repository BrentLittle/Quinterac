...
public class MasterFileObj {
	...
	private void createAccountObjects() throws IOException, InvalidAccountException {
		...
		try {
			input = new FileInputStream(filePath + "\\MasterAccountsFile.txt");
		} catch (IOException e) {
	...
	public void updateMaster() throws IOException {
        ...
        String newMaster = "";
        String newValid = "";
        File master = new File(filePath + "\\MasterAccountsFile.txt");
        File valid = new File(filePath + "\\ValidAccountsFile.txt");
